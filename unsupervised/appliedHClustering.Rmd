---
title: "appliedUnsupervisedLearning"
...
##задача
a gene expression data set (Ch10Ex11.csv) that consists of 40 tissue samples with measurements on 1,000 genes. The first 20 samples are from healthy patients, while the second 20 are from a diseased group
```{r}
...
```
*2* Apply hierarchical clustering to the samples using correlation
